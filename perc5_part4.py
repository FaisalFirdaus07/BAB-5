...
def main():
    ...
    try:
        ...
        time.sleep(2)
        print("Serial ke Arduino berhasil terhubung.")
    except :
        print("Error: Tidak dapat terhubung ke Arduino")
        arduino = None
    ...
    color_ranges = {
        ...
        "Merah": ((np.array([0, 50, 50]), np.array([10, 255, 255])),
    ...
    while True:
        ...
        cv2.imshow("Tracking Objek", frame)
